...
class Ui_applyScholarshipForm(object):
    def setupUi(self, applyScholarshipForm):
        ...
        applyScholarshipForm.resize(535, 518)
        ...
        applyScholarshipForm.setMinimumSize(QtCore.QSize(535, 518))
...
"margin-bottom:30px;")
        ...
        self.proofOfNeedTxt = QtWidgets.QLineEdit(parent=self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.proofBrowseBtn.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.proofBrowseBtn.setStyleSheet("border:none;\n"
"border-radius:5px;\n"
...
"color:rgb(1, 14, 27);")
        ...
        self.proofBrowseBtn.setIcon(icon)
        self.proofBrowseBtn.setObjectName("proofBrowseBtn")
...
"color:rgb(1, 14, 27);")
    ...
    def retranslateUi(self, applyScholarshipForm):
        ...
        self.label_28.setText(_translate("applyScholarshipForm", "Former School                          "))
        self.formerSchoolTxt.setPlaceholderText(_translate("applyScholarshipForm", "e.g. Greenwich University"))
