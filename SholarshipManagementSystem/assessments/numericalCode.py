...
class NumericalReasoningCode(QWidget, Ui_NumericalReasoningForm):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.setWindowTitle("Numerical Reasoning")
        ...
        self.numericalReasoningStackedWidget.setCurrentIndex(0)
